...
- 3 أرقام: المساحة (محسوبة من الحدود)، نسبتها من مساحة المحافظة (من `Shape__Area`)،
  و**الترتيب حسب الرمز**: موقع التجمع بين تجمعات محافظته مرتبة حسب `LOCCODE` (مثلاً حارس 7 من 20 بسلفيت) — مربع ذهبي.
- الملاحظات (مثل "تشمل ...") بصندوق.
- السابق/التالي (وأسهم الكيبورد ← →) بترتيب الرمز داخل المحافظة، واسم التجمع السابق/التالي تحت الزر.
  استثناء: إذا انفتح التجمع من بحث بالاسم، التنقل على نتائج البحث.
